        ...
        <div className="grid lg:grid-cols-12 gap-10 sm:gap-16 lg:gap-20">
          <div className="lg:col-span-4 lg:sticky lg:top-40 h-fit">
            ...
            >
              ...
              <h2 className="text-3xl sm:text-5xl md:text-7xl font-heading font-bold mb-6 sm:mb-8 leading-tight">The Growth <br /> Engine.</h2>
          ...
          <div className="lg:col-span-7 lg:col-start-6 space-y-16 sm:space-y-28 lg:space-y-40">
            {steps.map((step, i) => (
              <motion.div 
                key={i}
              ...
              >
                ...
                <div className="relative z-10">
                  <h3 className="text-2xl sm:text-3xl font-bold mb-4 sm:mb-6 tracking-tight group-hover:text-red-500 transition-colors duration-500">{step.title}</h3>
                  <p className="text-white/50 text-base sm:text-xl font-light leading-relaxed max-w-xl">
                    {step.desc}
                  </p>
                </div>
                {/* Connector Line */}
