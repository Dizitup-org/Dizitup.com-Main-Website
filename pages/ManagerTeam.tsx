        ...
        {loading ? (
          ...
          <div className="space-y-8">
            {(user?.adminRole === 'manager'
              ? [{ label: 'Staff', data: employees, role: 'employee' }]
              : [{ label: 'Managers', data: managers, role: 'manager' }, { label: 'Staff', data: employees, role: 'employee' }]
            ).map(({ label, data }) => (
              <div key={label}>
                          ...
                          {editingId === s.admin_id ? (
                            <>
                              ...
                              >
                                ...
                                <option value="employee" style={{ color: '#000000', backgroundColor: '#ffffff' }}>Staff</option>
                              </select>
